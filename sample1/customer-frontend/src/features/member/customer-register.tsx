...
export function CustomerRegister() {
  ...
  return (
    <div className="w-full rounded-[1.75rem] border border-[#2b1b46]/10 bg-white p-5 shadow-[0_24px_70px_rgba(48,28,76,.13)] sm:p-7">
      <div className="mb-5 flex items-center gap-3 rounded-2xl bg-[#fff2e4] p-4 text-sm text-[#75401f]">
      ...
      >
        ...
        <Button className="h-12 w-full rounded-xl bg-[#ff7a1a] text-base text-white hover:bg-[#e9650d]">
          建立會員帳戶 <ArrowRight />
        </Button>
      </form>
      <p className="mt-5 text-center text-sm text-[#776d82]">
        已有帳戶？{" "}
        <Link href="/login" className="font-bold text-[#6d3df5]">
          返回登入
        </Link>
      </p>
    </div>
